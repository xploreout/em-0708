    ...
    <section className='py-20 bg-white'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-left mb-14'>
          <h2 className='text-4xl font-bold text-gray-900'>Children AWANA</h2>
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-8 items-start'>
          ...
          <div className='w-full md:w-1/2 text-gray-600 leading-relaxed space-y-4'>
            <p>
              Children are discipled to know, love and serve Jesus with
              memorizing Bible verses, completing a Bible-based handbook,
