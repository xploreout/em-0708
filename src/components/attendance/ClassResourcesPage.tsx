...
import { Search, FileText, FileImage, File, Download, Clock, MapPin, Users, Archive, ChevronDown, ChevronRight, BookOpen, Youtube } from 'lucide-react'
            ...
            <div className="flex flex-col gap-1">
              {cls.documents.map(doc => {
                ...
                return (
                  ...
                  >
                    {vid
                      ? <img src={`https://img.youtube.com/vi/${vid}/default.jpg`} alt="" className="w-12 h-8 object-cover rounded flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      {isYt && (
                        <a href={doc.url} target="_blank" rel="noopener noreferrer"
                          className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-red-500 hover:bg-red-600 text-white text-xs font-semibold transition">
